...
vi.mock('@/app/(dashboard)/workflows/actions', () => ({
  upsertTemplateStepRow: (...args: unknown[]) => upsertMock(...(args as [])),
...
vi.mock('@/app/(dashboard)/workflows/[id]/todo-composer-modal', () => ({
  TaskComposerModal: () => null,
}))
vi.mock('@/app/(dashboard)/workflows/[id]/note-composer-modal', () => ({
  NoteComposerModal: () => null,
}))
vi.mock('@/app/(dashboard)/workflows/[id]/questionnaire-composer-modal', () => ({
  QuestionnaireComposerModal: () => null,
}))
vi.mock('@/app/(dashboard)/workflows/[id]/timeline-composer-modal', () => ({
  TimelineComposerModal: () => null,
}))
vi.mock('@/app/(dashboard)/workflows/[id]/run-sheet-composer-modal', () => ({
  RunSheetComposerModal: () => null,
}))
vi.mock('@/app/(dashboard)/workflows/[id]/document-composer-modal', () => ({
