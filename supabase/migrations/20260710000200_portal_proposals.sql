-- Portal: surface proposals in get_portal_data (Proposals Phase F).
--
-- The portal's payments section now lists the couple's proposals
-- alongside quotes and invoices (quotes leave in the removal phase).
-- Function replacement only — same body as 20260625000000 plus the
-- payments.proposals array. Not destructive.
