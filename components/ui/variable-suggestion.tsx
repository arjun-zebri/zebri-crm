...
export const VariableSuggestionList = forwardRef<ListHandle, ListProps>(function VariableSuggestionList(
  ...
  return (
    <div className="max-h-72 w-56 overflow-y-auto rounded-xl border border-gray-200 bg-white p-1 shadow-lg">
      {items.map((v, i) => (
        <button
          key={v.id}
          type="button"
          ...
          className={`w-full cursor-pointer rounded-md px-2 py-1 text-left ${i === active ? 'bg-gray-50' : ''}`}
        >
