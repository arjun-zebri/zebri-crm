...
- **Styled numbers**: bold or italic at the start of an item's text carries onto its number, and H1/H2/H3 work inside a list so a clause title can be a numbered heading with a heading-sized number.
