/**
 * Shared types + pure helpers for the public-proposal surface.
 *
 ...
 * layouts are deliberately NOT supported here — a block tree can't
 * express the option chooser — so the page always renders the
 * scalar-branded card (colors, fonts, logo, density, radius).
 *
