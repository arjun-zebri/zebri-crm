  ...
  if (!isTypeform) {
    return (
      <div className="py-6">
        ...
        <h1 className="mb-1.5 text-3xl font-semibold" style={{ color: theme.textColor, fontFamily: theme.headingStack }}>
          {questionnaire.title}
        </h1>
        <p className="mb-8 text-sm" style={{ color: theme.mutedColor }}>
