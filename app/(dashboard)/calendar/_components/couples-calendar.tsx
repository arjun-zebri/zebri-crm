  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="inline-flex items-center gap-1.5 h-9 px-3 text-sm font-medium border border-gray-200 rounded-md bg-white hover:bg-gray-50 transition cursor-pointer"
      >
        ...
        <div className="flex-shrink-0 flex items-center justify-between mb-5 pb-4 border-b border-gray-200">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="md:hidden h-9 w-9 inline-flex items-center justify-center text-gray-500 hover:bg-gray-100 rounded-md transition cursor-pointer"
            >
            ...
            <button
              ...
              className="inline-flex items-center h-9 px-3 text-sm font-medium text-gray-900 border border-gray-200 bg-white hover:bg-gray-50 rounded-md transition cursor-pointer"
            >
              Today
            </button>
            <button
              ...
              onClick={handlePrev}
              className="h-9 w-9 inline-flex items-center justify-center text-gray-500 hover:bg-gray-100 rounded-md transition cursor-pointer"
            >
