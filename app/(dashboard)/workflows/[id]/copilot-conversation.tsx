/**
 * Conversation rendering for the Zebri AI panel: chat bubbles per entry
 * kind (with the sender's name inside the bubble, under the message),
 * the typing reveal, and auto-scroll.
 *
 * There is no greeting turn. The panel only opens once the MC has said
 * something, so a canned "tell me what should happen" bubble was an AI
 * message that answered nothing, sat above every real exchange for the
 * life of the page, and said what the composer's placeholder already
 * says.
 *
 * @module app/(dashboard)/workflows/[id]/copilot-conversation
 */
'use client'
      ...
      <div className="flex flex-col gap-2">
        {draftOnly && (
          <div className="text-body text-text-subtle leading-relaxed px-1">
            This workflow is live. I can answer questions, but make it a draft before asking me to
            change steps.
          </div>
        )}
        {entries.map((e) => (
