...
function Tok({ children, testId }: { children: ReactNode; testId?: string }) {
  return (
    <span data-testid={testId} className="rounded-control bg-green-50 px-1 py-px text-[10px] font-medium text-green-700">
      {children}
    </span>
  )
}
  ...
  const modal = show(2) && (
    <Backdrop>
      <PreviewModal
        ...
        wide
        footer={
          <span className="rounded-control px-3 py-1 text-body bg-brand-fg text-text-inverse">
            Save template
          </span>
        }
      >
        <div className="flex gap-2">
          <div className="flex-1 min-w-0" data-cursor="tpl-name">
            ...
            <div className="rounded-control border border-border px-2 h-6 flex items-center text-[11px] font-medium text-text">
              {show(3) ? (
          ...
          <div className="w-24 shrink-0">
            ...
            <div className="rounded-control border border-border px-2 h-6 flex items-center justify-between gap-1 text-[10px] text-text">
              <span className="flex items-center gap-1 truncate">
                <span className="size-1.5 rounded-pill bg-info shrink-0" />
                Enquiry
              </span>
        ...
        <div>
          ...
          <div className="rounded-control border border-border px-2 h-6 flex items-center text-[11px] text-text overflow-hidden">
        ...
        <div>
          <div className="flex items-center justify-between mb-0.5">
            ...
            <span
              ...
              className="inline-flex items-center gap-1 rounded-control px-1.5 py-0.5 text-[10px] bg-brand-fg text-text-inverse"
            >
          ...
          <>
            <div className="flex items-center justify-between pb-2 border-b border-border animate-fade-in">
              ...
              <span
                ...
                className="inline-flex items-center gap-1 rounded-control px-2 py-1 text-body border border-brand-fg bg-brand-fg text-text-inverse"
              >
            ...
            <div className="flex gap-2 border-b border-border pb-1 animate-fade-in">
              <span className="text-body font-medium text-text border-b-2 border-brand-fg pb-1">Emails</span>
              <span className="text-body text-text-subtle">Packages</span>
              <span className="text-body text-text-subtle">Invoices</span>
            </div>
          </>
        )}
      </div>
