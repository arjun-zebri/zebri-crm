        ...
        addBlockSlot={
          <AddBlockPalette
            ...
            trigger={
              <button
                type="button"
                className="inline-flex items-center gap-1.5 px-2.5 h-8 rounded-control bg-surface border border-border hover:border-border-strong text-gray-700 hover:text-text text-xs font-medium cursor-pointer transition"
                title="Add block"
              >
