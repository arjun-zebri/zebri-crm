      ...
      {items.map((item) => (
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-sm text-emerald-600 border border-emerald-200 bg-emerald-50 rounded-control px-3 py-2 hover:bg-emerald-100 transition cursor-pointer disabled:opacity-50 shrink-0"
          >
