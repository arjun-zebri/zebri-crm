  ...
  return (
    <aside className="w-[320px] shrink-0 border-r border-border bg-surface flex flex-col">
      ...
      <div className="flex-1 px-4 py-4">
        <div className="bg-surface-muted rounded-lg p-3 space-y-2 animate-pulse">
      ...
      <div className="border-t border-border p-3">
        <div className="rounded-lg border border-border bg-surface-muted/40 h-[88px] animate-pulse" />
      </div>
    </aside>
  )
}
  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex items-start justify-center pt-24">
        <div className="w-[240px] rounded-xl border border-border bg-surface flex items-center gap-3 px-3 py-2.5 animate-pulse">
