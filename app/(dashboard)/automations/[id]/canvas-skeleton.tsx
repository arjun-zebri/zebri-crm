...
function HeaderSkeleton() {
  return (
    <header className="flex items-center gap-3 px-6 py-3 border-b border-border bg-surface">
      ...
      <div className="h-5 w-40 bg-gray-100 rounded-control animate-pulse" />
      <div className="ml-auto flex items-center gap-3">
        <div className="h-5 w-16 bg-gray-100 rounded-pill animate-pulse" />
        <div className="h-4 w-24 bg-gray-100 rounded-control animate-pulse" />
        <div className="h-8 w-24 bg-gray-100 rounded-control animate-pulse" />
        <div className="h-8 w-24 bg-gray-100 rounded-control animate-pulse" />
      </div>
    </header>
  )
    ...
    <aside className="w-[320px] shrink-0 border-r border-border bg-surface flex flex-col">
      <div className="px-4 pt-3 pb-3 border-b border-border">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-control bg-gray-100 animate-pulse" />
          <div className="h-4 w-20 bg-gray-100 rounded-control animate-pulse" />
        </div>
        <div className="h-3 w-56 bg-gray-100 rounded-control mt-2 animate-pulse" />
      </div>
      <div className="flex-1 px-4 py-4">
        <div className="bg-surface-muted rounded-control p-3 space-y-2 animate-pulse">
          <div className="h-3 w-full bg-gray-100 rounded-control" />
          <div className="h-3 w-5/6 bg-gray-100 rounded-control" />
          <div className="h-3 w-2/3 bg-gray-100 rounded-control" />
        </div>
      </div>
    ...
    >
      <div className="absolute inset-0 flex items-start justify-center pt-24">
        <div className="w-[240px] rounded-control border border-border bg-surface flex items-center gap-3 px-3 py-2.5 animate-pulse">
          <div className="w-4 h-4 rounded-control bg-gray-100 shrink-0" />
          <div className="flex-1 space-y-1.5">
            <div className="h-3 w-24 bg-gray-100 rounded-control" />
            <div className="h-2.5 w-32 bg-gray-100 rounded-control" />
          </div>
        </div>
      </div>
    </div>
