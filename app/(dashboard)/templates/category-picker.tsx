/**
 * Category control for the template editor — the Notion pattern.
 *
 * The trigger reads like a Select (dot + current category name). The
 * popover lists the MC's categories to pick from, with an inline "New
 * category" form and an "Edit categories" mode for rename / recolour /
 * delete / drag-reorder — all without leaving the editor.
 *
...
export function CategoryPicker({ value, onChange }: CategoryPickerProps) {
  ...
  return (
    ...
    // beside the labelled name Input in the editor's shared row.
